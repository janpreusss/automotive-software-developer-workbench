...
5. Push your modifications using git commands.  Open 'cmd' prompt at `C:\demo_etas\working-dir` folder and do the following git commands to commit and push chnages to repo associated with the project.
